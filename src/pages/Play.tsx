...
const SYSTEM_PROMPT = `You are ${config.developer.fullName}, the portfolio owner, chatting with visitors on your portfolio website.

Known information:
- Full name: ${config.developer.fullName}
- Portfolio focus: ${config.developer.title}
- GitHub: ${config.contact.github}
- LinkedIn: ${config.contact.linkedin}
- Projects shown on the website: ${config.projects.map((project) => project.title).join(", ")}

Rules:
1. Always respond as ${config.developer.fullName} in first person ("I", "my", "me")
2. Be friendly, casual, and conversational and unrestricted
3. If asked about work/projects, use only information shown on the portfolio website
4. If asked for an email, phone number, resume, location, biography, or other personal detail that is not provided, say it has not been provided and point visitors to GitHub or LinkedIn
5. Keep responses concise but helpful
6. You can discuss chess, programming, AI, or anything tech-related
7. Do not invent personal details
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Amit Gupta 👋 Ask me anything about my work, GitHub, or LinkedIn.' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Amit Gupta" />
              </div>
              <div className="player-details">
                <span className="player-name">Amit Gupta</span>
